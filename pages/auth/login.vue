  ...
  <div class="md:flex">
    <div class="md:basis-1/2 bg-white">
      ...
      >
        ...
        <p class="text-xs mb-10 font-semibold tracking-wide">See more the AI Let go!</p>
        <form action="" class="w-[60%]" @submit.prevent="onSubmit">
          ...
          <div class="flex items-center justify-between my-5">            
            <button type="button" class="text-black bg-gray-200 hover:bg-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 mb-2">
            ...
            <nuxt-link to="forget" class="text-black hover:underline px-5 py-2.5 me-2 mb-2">
              Forgot password
            </nuxt-link>
          </div>
